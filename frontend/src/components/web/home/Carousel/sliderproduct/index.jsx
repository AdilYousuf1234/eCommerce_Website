                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    ...
                                    <div className="add">
                                        <button className="btn btn-danger my-cart-btn my-cart-b" onClick={() => this.props.state.addToCart("sunfloweroil")}>Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    ...
                                    <div className="add">
                                        <button className="btn btn-danger my-cart-btn my-cart-b" onClick={() => this.props.state.addToCart("kabulichana")}>Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
